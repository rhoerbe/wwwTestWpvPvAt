...
|SP2 Echo-Service mit IdP discovery service und Request Initiation Protocol | https://sp2.test.wpv.portalverbund.at:4443/Shibboleth.sso/Login?target=https%3A%2F%2Fecho.test.wpv.portalverbund.at%2Fsecure%2Fecho.php&entityID=https%3A%2F%2Fidp1.test.wpv.portalverbund.at%2Fidp/shibboleth
