...
* Export der Metadaten des SP. Dabei ist zu prüfen, dass die Metadaten den Anforderungen genügen.
  ...
  https://mdfeed.test.wpv.portalverbund.at/unsigned/sp1TestWpvPortalverbundAt_idpShibboleth/ed.xml[sp1.test.wpv.portalverbund.at] (SP). Man findes Sie mit der Suchfunktion im MDX-Service.
